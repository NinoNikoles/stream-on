...
$(document).ready(function() {
    page = {
        ...
        updateOverlay: function () {
            function loader() {
                if ( !($('#modal').length > 0) ) {
                    self.$body.append('<div class="modal" id="modal"><div class="modal-overlay"></div><div class="content-wrap"><i class="icon-spinner"></i><span>Loading content,<br>please wait.</div></div>');
                }
