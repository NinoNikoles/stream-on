    ...
    page = {
        ...
        movieTimeSafe: function() {
            ...
            if ( $('#mainPlayer').length > 0 ) {
                ...
                // Gesamtlänge des Videos ausgeben, wenn die Metadaten geladen sind
                $(video).on('loadedmetadata', function() {
                    console.log('Gesamtlänge des Videos: ' + video.duration + ' Sekunden');
                });
                ...
                // Funktion, um die aktuelle Zeit des Videos anzuzeigen, wenn es abgespielt wird
                ...
                // Alle 10 Sekunden die aktuelle Zeit aktualisieren
                setInterval(updateCurrentTime, 10000); // 10000 Millisekunden = 10 Sekunden
            }
            /*$sql = 'CREATE TABLE IF NOT EXISTS movie_watched (
                id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
                user_id INT UNSIGNED,
                movie_id INT UNSIGNED,
                watched_seconds INT UNSIGNED,
