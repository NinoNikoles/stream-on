                    ...
                    echo '<div id="edit-user-'.$row['id'].'" style="display:none;">';
                        ...
                        echo '<form method="post" action="/admin/users">';
                            ...
                            echo '<p class="text-right marg-no">';
                                echo '<button class="btn btn-success icon-left icon-save" type="submit" name="edit-user">'.lang_snippet('save').'</button>';
                            echo '</p>';
                        echo '</form>';
                    echo '</div>';
                    ...
                    echo '<div id="delete-user-'.$row['id'].'" style="display:none;">';
                        ...
                        echo '<form method="post" action="/admin/users">';
                            echo '<p class="text-right marg-no">';
                                ...
                                echo '<button class="btn btn-alert icon-left icon-trash" type="submit" name="delete-user">'.lang_snippet('delete').'</button>';
                            echo '</p>';
                        echo '</form>';
                    echo '</div>';
                }
