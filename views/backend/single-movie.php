                ...
                <div class="col4">
                    ...
                    <div class="col12 marg-bottom-s">
                        <a href="#movie-poster" data-fancybox data-src="#movie-poster">
                            <figure class="poster">
                                <img src="/views/build/css/images/img_preview.webp" data-src="<?php echo $tmdb->getImageURL().$poster; ?>" loading="lazy">
                            </figure>
                        </a>
                                            ...
                                            echo '<div class="col3 column">';
                                                echo '<div class="poster-select">';
                                                    ...
                                                    echo '<figure class="poster">';
                                                        echo '<img src="/views/build/css/images/img_preview.webp" data-src="'.$tmdb->getImageURL().$moviePoster.'" loading="lazy">';
                                                    echo '</figure>';
                                                echo '</div>';
                                            echo '</div>';
                                        }
                    ...
                    <div class="col12">
                        <a href="#movie-backdrop" data-fancybox data-src="#movie-backdrop">
                            <figure class="original">
                                <img src="/views/build/css/images/img_preview.webp" data-src="<?php echo $tmdb->getImageURL().$backdrop;?>" loading="lazy">
                            </figure>
                        </a>
                                        ...
                                        echo '<div class="col3 column">';
                                            echo '<div class="poster-select">';
                                                ...
                                                echo '<figure class="original">';
                                                    echo '<img src="/views/build/css/images/img_preview.webp" data-src="'.$tmdb->getImageURL().$movieBackdrop.'" loading="lazy">';
                                                echo '</figure>';
                                            echo '</div>';
                                        echo '</div>';
                                    }
                        ...
                        if ( movieIsInCollection($movieID) !== true ) {
                            echo '<div class="col3 column">';
                                echo '<a href="#add-movie-'.$movieID.'" class="media-card" data-fancybox data-src="#add-movie-'.$movieID.'">';
                                    echo '<figure class="poster">';
                                        echo '<img src="/views/build/css/images/img_preview.webp" data-src="'.$tmdb->getImageURL().$movie->getPoster().'" alt="" loading="lazy">';
                                    echo '</figure>';
